//Modified Old frontend before integration with backend
...
//New frontend with ISSUES integrated with backend
// import { useEffect, useMemo, useState } from 'react';
// import { Link } from 'react-router-dom';
// import { getOperators, getTickets } from '../lib/api';
// import { mapOperator, mapTicket } from '../lib/mappers';
...
//           <p className="hero-badge">University of Sunderland</p>
...
//               <input
//                 type="text"
//                 placeholder="Search operator, ticket, or travel type..."
//                 value={search}
//                 onChange={(e) => setSearch(e.target.value)}
//                 className="search-bar-input"
//                 aria-label="Search travel options"
...
//             {filteredOperators.map((op) => (
//               <div key={op.id} className="operator-card">
//                 <span className="operator-type">{op.type}</span>
//                 <h3>{op.name}</h3>
//                 <p>{op.description}</p>
...
//                   ))}
//                   {op.tickets.length > 3 && (
//                     <span className="more-tickets">+{op.tickets.length - 3} more</span>
//                   )}
//                 </div>

//                 <div className="operator-footer">
//                   <span>From {op.tickets[0]?.price || 'N/A'}</span>
//                   <Link to="/ticketing" className="operator-link">
//                     View all prices →
//                   </Link>
//                 </div>
...
//           <h2>Travel Greener Today</h2>
//           <p>
//             Small changes in how you travel make a big difference. Explore sustainable options and
//             find what works for your commute.
//           </p>
//           <Link to="/sustainability" className="banner-button">
//             Sustainability Tips
//           </Link>
//         </div>
//       </section>
